...
class KCI_UInd(object):
    def __init__(self, sample_size, kernelX=None, kernelY=None, est_width='empirical', null_sample_size=1000, approx=True):
        self.T = sample_size
    ...
    def null_sample_spectral(self, Kxc, Kyc):
        ...
        lambda_prod = np.dot(lambdax.reshape(self.num_eig,1), lambday.reshape(1,self.num_eig)).reshape((self.num_eig**2,1))
